...
public class CustomerReportNew extends JInternalFrame {
	...
	public CustomerReportNew() {
		...
		JLabel l1 = new JLabel("CUSTOMER REPORT");
		...
		try {
			...
			rs = st.executeQuery("select COUNT(*) from customer_master");
			rs.next();
			Object rowData[][] = new Object[rs.getInt(1)][6];
			Object columnNames[] = { "ID", "Customer Name", "Contact No", "Email", "Register Date" };
			int i = 0, j = 0;
